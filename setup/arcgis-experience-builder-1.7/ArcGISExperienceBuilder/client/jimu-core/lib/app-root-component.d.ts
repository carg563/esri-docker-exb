...
declare const _default: React.FC<import("react-intl").WithIntlProps<import("react-redux").Omit<StateProps & IntlProps, "hasNewVersion" | "appPath" | "queryObject" | "userLocaleChanged" | "hasPrivilege" | "privilegeError" | "loadAppConfigError" | "portalsNeedToRegisterClinetId" | "isRTL" | "currentDialogId" | "isBusy" | "loadingType" | "pages" | "customTheme" | "dispatch" | "dialogJson" | "appConfigLoaded"> & IntlProps>> & {
    WrappedComponent: React.ComponentType<import("react-redux").Omit<StateProps & IntlProps, "hasNewVersion" | "appPath" | "queryObject" | "userLocaleChanged" | "hasPrivilege" | "privilegeError" | "loadAppConfigError" | "portalsNeedToRegisterClinetId" | "isRTL" | "currentDialogId" | "isBusy" | "loadingType" | "pages" | "customTheme" | "dispatch" | "dialogJson" | "appConfigLoaded"> & IntlProps>;
};
