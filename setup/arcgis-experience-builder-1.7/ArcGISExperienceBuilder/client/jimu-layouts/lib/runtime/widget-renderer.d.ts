...
export declare const WidgetRenderer: ReactRedux.ConnectedComponent<typeof _WidgetRenderer, ReactRedux.Omit<React.ClassAttributes<_WidgetRenderer> & LayoutItemProps & WidgetProps, "rotate" | "widgetId" | "supportInlineEditing" | "supportRepeat" | "hasEmbeddedLayout" | "canCrossLayoutBoundary" | "isClassLoaded" | "isInlineEditing" | "widgetJson" | "isFunctionalWidget" | "widgetState" | "widgetStyle" | "hasExtension"> & LayoutItemProps>;
export {};
