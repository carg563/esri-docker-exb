/** @jsx jsx */
import { jsx, css, React, ImmutableArray, classNames, lodash, ResizeObserver } from 'jimu-core'
...
export function TaskListInline (props: QueryTaskListProps) {
  ...
  return (
    <div ref={containerRef} css={style} className={classNames('runtime-query__query-list h-100 d-flex', { 'flex-wrap': wrap })}>
      ...
      {nonExpandedArray.length > 0 && (
        ...
        >
          <QueryTaskList widgetId={widgetId} queryItems={nonExpandedArray as any} />
        </TaskListPopperWrapper>
      )}
    </div>
  )
