            ...
            flow='wrap' label={
              <div className='w-100 d-flex'>
                ...
                <Button size='sm' type='tertiary' icon onClick={this.handleShowSimpleClick} className='collapse-btn'>
                  {showSimple ? <UpOutlined color={theme.colors.black}/> : <DownOutlined color={theme.colors.black}/>}
                </Button>
              </div>
            }
          >
            ...
            flow='wrap' label={
              <div className='w-100 d-flex'>
                ...
                <Button size='sm' type='tertiary' icon onClick={this.handleShowAdvanceClick} className='collapse-btn'>
                  {showAdvance ? <UpOutlined color={theme.colors.black}/> : <DownOutlined color={theme.colors.black}/>}
                </Button>
              </div>
            }
          >
        ...
        flow='wrap' label={
          <div className='w-100 d-flex justify-content-between'>
            ...
            <Button size='sm' type='tertiary' icon onClick={this.handleShowArrangementClick}>
              {showArrangement ? <UpOutlined color={theme.colors.black}/> : <DownOutlined color={theme.colors.black}/>}
            </Button>
          </div>
        }
      >
