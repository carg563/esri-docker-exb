...
import { IMConfig, SuggestionItem, Suggestion, IMDatasourceConfigItem, DatasourceListItem } from '../../config'
...
export async function fetchSuggestionRecords (
  ...
  dsConfigItem: IMDatasourceConfigItem,
...
async function queryRecords (q: any, ds: DataSource): Promise<any> {
  ...
  return await (ds as QueriableDataSource)
    .query(q, { scope: QueryScope.InConfigView } as QueryOptions)
