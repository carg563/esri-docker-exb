...
import { RECENT_SEARCHES_KEY, IMConfig, DatasourceConfigItem, SuggestionItem, ServiceList, SearchServiceType, Suggestion, SearchResultView } from '../../config'
...
*/
export const getDatasourceConfigItemByConfigId = (config: IMConfig, configId: string): DatasourceConfigItem => {
