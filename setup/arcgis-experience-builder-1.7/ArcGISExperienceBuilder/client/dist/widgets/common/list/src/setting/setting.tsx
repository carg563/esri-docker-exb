        ...
        <SettingRow flow='wrap'>
          <div className='w-100 overflow-hidden'>
            ...
            <Tooltip
              ...
              placement='left'
            >
              <Button type='tertiary' aria-label={this.formatMessage('listUseGuide')}>
  ...
  renderArrangementSetting = () => {
    ...
    return (
      <SettingSection>
        ...
        >
          <SettingRow className="mt-2" label={this.formatMessage('direction')} role='group' aria-label={this.formatMessage('direction')}>
            <DirectionSelector
          ...
          <SettingRow
            ...
            role='group'
            aria-label={(config.direction === DirectionType.Vertical ? this.formatMessage('itemHeight') : this.formatMessage('itemWidth')) + ' (px)'}
          >
            <MyNumericInput
              style={{ width: '100%' }}
              value={parseFloat(
          ...
          <SettingRow label=''>
            <Button title={this.formatMessage('lockItemRatio')} className='d-flex w-100' type='tertiary' style={{ paddingLeft: 0, paddingRight: 0 }} onClick={() => { this.handleCheckboxChange('lockItemRatio') }}>
              <Checkbox
                className='lock-item-ratio'
