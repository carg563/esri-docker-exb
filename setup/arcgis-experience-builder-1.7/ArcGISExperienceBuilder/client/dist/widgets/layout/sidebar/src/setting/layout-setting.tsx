...
import { Switch, Select, UnitTypes, LinearUnit, Icon, Button, NumericInput, Collapse, utils as uiUtils } from 'jimu-ui'
        ...
        >
          <Collapse isOpen={config.toggleBtn.visible}>
            <SettingRow label={formatMessage('style')} flow='wrap'>
              <div className='d-flex w-100 justify-content-between'>
                <Button
                  ...
                  aira-pressed={toggleBtnTemplate === STYLE_NAMES[0]}
                ...
                >
                  ...
                  >
                    <DownOutlined className='mr-0' size={14} />
                  </div>
                </Button>
                <Button
                  ...
                  aira-pressed={toggleBtnTemplate === STYLE_NAMES[1]}
            ...
            <SettingRow label={formatMessage('iconSize')}>
              <NumericInput aria-label={formatMessage('iconSize')} size='sm' style={inputStyle} value={config.toggleBtn.iconSize} onChange={this.updateControllerIconSize} />
            </SettingRow>
          </Collapse>
        </SettingSection>
        <SettingSection
