...
export declare class JimuMapView {
     ...
     */
    drawFeatureSet(dataSource: DataSource, records: DataRecord[], targetLayerId: string, title?: string): Promise<__esri.Graphic[]>;
    /**
     ...
     */
    updateDrawFeatureSet(dataSource: DataSource, records: DataRecord[], targetLayerId: string, title?: string): Promise<__esri.Graphic[]>;
    /**
     * Get the graphics from `dataRecords`
     */
    getGraphicsFromRecords(dataSource: DataSource, records: DataRecord[]): Promise<__esri.Graphic[]>;
    /**
     * get default symbol
     */
