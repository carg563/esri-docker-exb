 ...
 * ```
 */
export declare const Dropdown: import("@emotion/styled").StyledComponent<DropdownProps, {}, {}>;
export declare class _DropdownSubMenuItem extends _Dropdown {
}
export declare const DropdownSubMenuItem: import("@emotion/styled").StyledComponent<DropdownProps, {}, {}>;
export {};
