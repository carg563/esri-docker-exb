...
export declare const _DropdownButtonRef: React.ForwardRefExoticComponent<DropdownButtonProps & IntlProps & React.RefAttributes<HTMLElement>>;
/**
 * The `DropdownButton` component is a button element in a `Dropdown` component to toggle the dropdown menu.
 *
 * Please use this component together with `Dropdown`, `DropdownMenu` and `DropdownItem`.
 ...
 * ```
 */
export declare const DropdownButton: import("@emotion/styled").StyledComponent<Omit<DropdownButtonProps & IntlProps, "intl"> & {
