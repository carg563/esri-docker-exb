...
}, ReactRedux.Omit<import("react-intl").WithIntlProps<Pick<MapWidgetSelectorProps & StateExtraProps & ExtraProps, "intl" | keyof MapWidgetSelectorProps | "mapWidgetJsons"> & {
    theme?: import("jimu-core").IMThemeVariables;
