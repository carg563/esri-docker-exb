 ...
 */
export declare const LinkSelector: React.FC<import("react-intl").WithIntlProps<Pick<LinkSelectorProps & ExtraProps, "intl" | keyof LinkSelectorProps> & {
    theme?: import("jimu-core").IMThemeVariables;
}>> & {
    WrappedComponent: React.ComponentType<Pick<LinkSelectorProps & ExtraProps, "intl" | keyof LinkSelectorProps> & {
        theme?: import("jimu-core").IMThemeVariables;
    }>;
};
export {};
