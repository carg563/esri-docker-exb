 ...
 */
export declare const JimuLayerViewSelector: React.FC<import("react-intl").WithIntlProps<JimuLayerViewSelectorProps>> & {
    WrappedComponent: React.ComponentType<JimuLayerViewSelectorProps>; /**
     * The jimuLayerViewInfo of the layer selected by the onSelect function.
     */
};
