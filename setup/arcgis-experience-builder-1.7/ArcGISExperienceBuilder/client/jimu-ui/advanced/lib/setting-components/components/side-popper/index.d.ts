...
export declare const SidePopper: ReactRedux.ConnectedComponent<import("@emotion/styled").StyledComponent<SidePopperProps & ExtroProps, {}, {}>, ReactRedux.Omit<SidePopperProps & ExtroProps, "dispatch" | "leftSidebarCollapse" | "rightSidebarCollapse" | "isTemplatePage" | "layoutSelection"> & SidePopperProps>;
export {};
