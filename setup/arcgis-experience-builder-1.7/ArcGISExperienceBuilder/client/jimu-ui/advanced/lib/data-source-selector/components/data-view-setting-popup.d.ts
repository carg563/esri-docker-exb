...
/** @jsx jsx */
import { React, jsx, IMDataViewJson, IMUseDataSource, DataSource, IntlShape, IMSqlExpression, OrderByOption, ImmutableObject, DataRecord, WidgetJson, ReactRedux, QueryParams, cancelablePromise, IMDataSourceSchema } from 'jimu-core';
...
interface State {
    dataView: IMDataViewJson;
    previewTableRecords: DataRecord[];
