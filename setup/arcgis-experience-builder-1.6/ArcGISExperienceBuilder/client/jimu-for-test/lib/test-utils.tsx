...
import { React, IntlProvider, ThemeVariables, IMState, ReactRedux, getAppStore, I18nMessages, utils, IMThemeVariables, SupportedLayerTypes } from 'jimu-core'
...
import { ThemeProvider } from 'jimu-theme'
 ...
 * @param messages
 */
export const withThemeIntlRender = (theme = mockTheme, locale: string = 'en', messages: I18nMessages = {}): WithRenderResult => {
 ...
 * @param theme
 */
export const withThemeRender = (theme = mockTheme): WithRenderResult => {
