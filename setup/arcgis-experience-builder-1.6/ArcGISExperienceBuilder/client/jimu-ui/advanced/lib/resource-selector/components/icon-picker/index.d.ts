 ...
 */
export declare const _IconPicker: ReactRedux.ConnectedComponent<typeof __IconPicker, ReactRedux.Omit<Pick<React.ClassAttributes<__IconPicker> & IconPickerProps & ExtraProps, keyof React.ClassAttributes<__IconPicker>> & Partial<Pick<React.ClassAttributes<__IconPicker> & IconPickerProps & ExtraProps, keyof IconPickerProps | keyof ExtraProps>> & Partial<Pick<IconPickerProps & ExtraProps, never>>, "intl" | "appInBuilderTheme"> & IconPickerProps>;
/**
 ...
 */
export declare const IconPicker: import("jimu-theme").StyledComponent<Omit<IconPickerProps, "intl"> & {
