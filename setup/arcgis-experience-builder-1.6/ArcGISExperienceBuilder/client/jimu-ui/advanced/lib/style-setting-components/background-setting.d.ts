 ...
 */
export declare const BackgroundSetting: import("jimu-theme").StyledComponent<ReactRedux.Omit<import("react-intl").WithIntlProps<any>, "dispatch" | "appTheme"> & BackgroundSettingProps & ExtraProps, {}, {}>;
export {};
