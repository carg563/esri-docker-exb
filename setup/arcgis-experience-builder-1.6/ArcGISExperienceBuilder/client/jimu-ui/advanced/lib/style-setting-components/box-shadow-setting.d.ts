 ...
 */
export declare const BoxShadowSetting: import("jimu-theme").StyledComponent<ReactRedux.Omit<import("react-intl").WithIntlProps<BoxShadowSettingProps & ExtraProps>, never> & BoxShadowSettingProps, {}, {}>;
export {};
