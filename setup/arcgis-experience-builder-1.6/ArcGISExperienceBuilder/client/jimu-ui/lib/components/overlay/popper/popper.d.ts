 ...
 * ```
 */
export declare const _Popper: React.MemoExoticComponent<React.ForwardRefExoticComponent<_PopperProps & Omit<PopperCoreProps, "children" | "reference" | "version"> & React.RefAttributes<import("@popperjs/core").Instance>>>;
/**
 * The `Popper` component is used to display some content adjacent to, but connected with, another component.
 *
 * ```ts
 ...
 * ```
 */
export declare const Popper: import("jimu-theme").StyledComponent<_PopperProps & Omit<PopperCoreProps, "children" | "reference" | "version"> & React.RefAttributes<import("@popperjs/core").Instance>, {}, {}>;
