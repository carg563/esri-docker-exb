 ...
 * ```
 */
export declare const Dropdown: import("jimu-theme").StyledComponent<DropdownProps, {}, {}>;
export declare class _DropdownSubMenuItem extends _Dropdown {
}
export declare const DropdownSubMenuItem: import("jimu-theme").StyledComponent<DropdownProps, {}, {}>;
export {};
