...
export interface AdvancedSelectProps {
    ...
    isMultiple?: boolean;
    /**
     * Whether to hide tools in the bottom, for multiple select.
     */
...
export declare class _AdvancedSelectInner extends React.PureComponent<AdvancedSelectProps & IntlProps & DatasourceProps, AdvancedSelectState> {
    ...
    searchInputKeyDown: (e: any) => void;
    showAllBtnKeyDown: (e: any) => void;
...
export declare const AdvancedSelect: import("jimu-theme").StyledComponent<Omit<AdvancedSelectProps & IntlProps, "intl"> & {
