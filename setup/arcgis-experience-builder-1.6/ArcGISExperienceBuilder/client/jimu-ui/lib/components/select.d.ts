 ...
 * ```
 */
export declare const Select: import("jimu-theme").StyledComponent<SelectProps & React.RefAttributes<HTMLInputElement>, {}, {}>;
/**
 * The options of the `DropdownMenu` in the Select component.
 *
 * ```ts
 ...
 * ```
 */
export declare const Option: import("jimu-theme").StyledComponent<Pick<SelectOptionProps, string | number> & React.RefAttributes<HTMLElement>, {}, {}>;
