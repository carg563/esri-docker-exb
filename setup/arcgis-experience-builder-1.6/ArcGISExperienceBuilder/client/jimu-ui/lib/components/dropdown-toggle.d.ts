...
export declare const DropdownToggle: import("jimu-theme").StyledComponent<Pick<Omit<DropdownToggleProps, "forwardedRef">, string | number> & React.RefAttributes<HTMLElement>, {}, {}>;
export {};
