 ...
 * ```
 */
export declare const DropdownItem: import("jimu-theme").StyledComponent<Pick<DropdownItemProps, string | number> & React.RefAttributes<HTMLElement>, {}, {}>;
