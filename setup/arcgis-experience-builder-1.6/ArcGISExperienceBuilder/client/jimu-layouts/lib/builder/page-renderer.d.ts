...
declare const _default: React.FC<import("react-intl").WithIntlProps<ReactRedux.Omit<React.ClassAttributes<PageRenderer> & PageProps & StateToProps, "footer" | "header" | "minHeight" | "theme" | "browserSizeMode" | "mainSizeMode" | "pages" | "dialogs" | "currentDialogId" | "activePagePart" | "headerVisible" | "footerVisible" | "splashDialogJson" | "isSplashClosed" | "pageDialogId" | "pageDialogJson" | "isPageDlgClosed" | "urlDialogJson" | "clipboardItem"> & PageProps>> & {
