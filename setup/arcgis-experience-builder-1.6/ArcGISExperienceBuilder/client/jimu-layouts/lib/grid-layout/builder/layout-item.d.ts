...
declare const _default: ReactRedux.ConnectedComponent<typeof GridItem, ReactRedux.Omit<React.ClassAttributes<GridItem> & LayoutItemProps & StateToLayoutItemProps & OwnProps, "selected" | "watchViewportVisibility" | "autoScroll" | "animationPreview" | "playMode" | "layoutItem" | "previewId"> & LayoutItemProps & OwnProps>;
