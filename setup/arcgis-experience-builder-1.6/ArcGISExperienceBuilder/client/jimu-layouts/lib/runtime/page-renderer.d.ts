...
declare const _default: ReactRedux.ConnectedComponent<typeof PageRenderer, ReactRedux.Omit<React.ClassAttributes<PageRenderer> & PageProps & StateToProps, "footer" | "header" | "theme" | "browserSizeMode" | "mainSizeMode" | "pages" | "headerVisible" | "footerVisible" | "splashDialogJson" | "isSplashClosed" | "pageDialogId" | "pageDialogJson" | "isPageDlgClosed" | "urlDialogJson"> & PageProps>;
