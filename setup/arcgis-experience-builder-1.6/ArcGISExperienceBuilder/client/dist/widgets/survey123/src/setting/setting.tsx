...
import {
  ...
  DataSourceTypes, getAppStore, ClauseValuePair
} from 'jimu-core'
...
import { Button, TextInput, Select, Radio, Switch, Label, Modal, AlertPopup, TagInput, AdvancedSelect } from 'jimu-ui'
...
export default class Setting extends React.PureComponent<AllWidgetSettingProps<IMConfig>, any> {
  ...
  public hardCodeTooltip = 'Please select a layer that contains at least one existing survey record.'
  public hardCodeErrorMsgForDisabledUser = 'You do not have permission to perform this action. Required privileges: publish hosted feature layers'
        ...
        <div className="survey123__section-createSurvey" style={
          ...
          <SettingSection>
            ...
            <div className="w-100 d-flex flex-wrap align-items-center justify-content-between setting-header setting-title pb-2">
              ...
              {!(this.state.newSurveyTags || this.state.newSurveyTags.length) && this.state.newSurveyTagsDirty
                ? <div className="error-message">
            ...
            <SettingRow flow="wrap">
              ...
              <span className="newSurvey-msg">{!this.state.canCreateSurvey ? this.hardCodeErrorMsgForDisabledUser : this.state.newSurveyMsg}</span>
          ...
          {this.props.config.mode === 'edit' && <React.Fragment>
            {this.state.mapWidgetList && this.state.mapWidgetList.length > 0
              ? <React.Fragment>
                ...
                <SettingRow className="fea-layer-outter">
                  <SettingRow className="use-feature-layer-setting" >
                    <span title={this.hardCodeTooltip}>{this.nls('selectSurveyLayer')}</span>
                  </SettingRow>
                  <div className="feature-layer-dropdown" title={this.hardCodeTooltip}>
