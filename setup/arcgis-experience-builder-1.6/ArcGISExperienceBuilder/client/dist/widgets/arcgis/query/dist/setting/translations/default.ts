export default {
  ...
  sketchTool_point: 'Point selection',
  sketchTool_polyline: 'Line selection',
  sketchTool_polygon: 'Polygon selection',
  sketchTool_rectangle: 'Rectangle selection',
  sketchTool_circle: 'Circle selection',
