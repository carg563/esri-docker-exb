...
export function QueryTaskResult (props: QueryTasResultProps) {
  ...
  return (
    <div className='query-result h-100' css={resultStyle}>
      <DataSourceComponent useDataSource={resultUseOutputDataSource} onDataSourceInfoChange={handleDataSourceInfoChange} />
      <div className='query-result__header d-flex align-items-center'>
        <Button className='p-0 mr-2' size='sm' type='tertiary' icon onClick={() => onNavBack()}>
      ...
      <div className='query-result-container mt-1'>
        <div className='query-result-info mb-2'>
          {getTipMessage()}
        </div>
