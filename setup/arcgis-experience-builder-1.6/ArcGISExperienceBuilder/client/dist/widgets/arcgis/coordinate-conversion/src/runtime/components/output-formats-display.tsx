          ...
          <table cellPadding={10}>
            <tbody>
              <tr>
                ...
                <td>
                  <TextInput required role={'textbox'} ref={this.editTextFocus} aria-label={this.nls('coordinateLabel')} value={this.state.outputFormatLabel}
              ...
              <tr className={this.props.conversionInfo.format.name === 'address' ? 'hidden' : ''}>
                ...
                <td>
                  <TextInput required role={'textbox'} aria-label={this.nls('coordinateFormat')} value={this.state.outputFormatPattern} onAcceptValue={this.onFormatChange}
