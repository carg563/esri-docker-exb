...
import coordinateConversionUtils from 'esri/widgets/CoordinateConversion/support/coordinateConversionUtils'
    ...
    this.state.coordinateVM.conversions.some((con) => {
      if (inputFormatName === con.format.name) {
        ...
        if (useFormatReverseConvert) {
          ...
          coordinateConversionUtils.fromGeoCoordinateString({
        ...
        <table cellPadding={10}>
          <tbody>
            ...
            <tr className={this.state.defaultCoords === 'address' ? 'hidden' : ''}>
              ...
              <td>
                <TextInput role={'textbox'} aria-label={this.nls('coordinateFormat')} value={this.state.defFormat} onAcceptValue={this.onFormatChange}
