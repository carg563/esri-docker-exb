...
import { Switch, Select, UnitTypes, LinearUnit, Icon, Button, NumericInput, utils as uiUtils } from 'jimu-ui'
          ...
          <SettingRow label={formatMessage('dockSide')} flow='wrap'>
            <div className='d-flex justify-content-between w-100' css={this.getDocksideStyle()}>
              <Button
                ...
                aira-checked={isHorizontal && side === CollapseSides.First}
                icon
              >
              ...
              <Button
                ...
                aira-checked={isHorizontal && side === CollapseSides.Second}
                icon
              >
            ...
            <SettingRow label={formatMessage('style')} flow='wrap'>
              <div className='d-flex w-100 justify-content-between'>
                <Button
                  ...
                  aira-checked={toggleBtnTemplate === STYLE_NAMES[0]}
                ...
                <Button
                  ...
                  aira-checked={toggleBtnTemplate === STYLE_NAMES[1]}
