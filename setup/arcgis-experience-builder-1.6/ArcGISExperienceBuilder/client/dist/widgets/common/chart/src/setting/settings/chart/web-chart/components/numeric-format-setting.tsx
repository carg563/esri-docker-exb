...
export const NumericFormatSetting = (props: NumericFormatSettingProps): React.ReactElement => {
  ...
  return (
    <div className='numeric-format-setting' css={style}>
      ...
      <SettingRow label={translate('notation')} flow='no-wrap' className='mt-2'>
        <Select
          size='sm'
          value={notation}
          className='w-50'
      ...
      {notation === 'standard' && <Label check className='justify-content-start align-items-start mt-2 setting-text-level-3'>
        <Checkbox
          checked={useGrouping}
