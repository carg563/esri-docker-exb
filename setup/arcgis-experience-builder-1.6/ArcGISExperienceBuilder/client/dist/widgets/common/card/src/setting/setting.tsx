...
import { LinkChainOutlined } from 'jimu-icons/outlined/editor/link-chain'
          ...
          <SettingRow>
            ...
            >
              <div className='w-100 px-2 text-truncate'>
                <LinkChainOutlined size={12} className='add-data-icon'/>
      ...
      <SettingSection
        title={
          <div className='w-100 d-flex justify-content-between'>
            ...
            >
              {showRegular ? <UpOutlined size={12} color={theme.colors.black}/> : <DownOutlined size={12} color={theme.colors.black}/>}
            </Button>
          </div>
        }
      >
      ...
      <SettingSection
        title={
          <div className='w-100 d-flex justify-content-between'>
            ...
            >
              {showHover ? <UpOutlined size={12} color={theme.colors.black}/> : <DownOutlined size={12} color={theme.colors.black}/>}
            </Button>
          </div>
        }
      >
