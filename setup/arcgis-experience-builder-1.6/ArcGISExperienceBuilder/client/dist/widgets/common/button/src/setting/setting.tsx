/** @jsx jsx */
import {
  React, IMState, urlUtils, jsx, Immutable, IMThemeVariables, ImmutableArray, ExpressionPartType, IMIconResult, ThemeButtonType,
...
import { SettingSection, SettingRow, IMLinkParam, LinkSettingPopup } from 'jimu-ui/advanced/setting-components'
import { IconPicker } from 'jimu-ui/advanced/resource-selector'
import { Button, TextInput, Select, Tabs, Tab, defaultMessages as jimuUIMessages, styleUtils, NormalLineType, UnitTypes, FillType, utils as uiUtils, defaultMessages as jimuUiDefaultMessages } from 'jimu-ui'
            ...
            <SettingSection>
              <SettingRow role='group' aria-label={this.props.intl.formatMessage({ id: 'setLink', defaultMessage: jimuUIMessages.setLink })} >
                <Button className="w-100 text-dark set-link-btn" type="primary" onClick={this.toggleLinkSetting} ref={this.linkSettingTrigger}
                  title={this.props.intl.formatMessage({ id: 'setLink', defaultMessage: jimuUIMessages.setLink })}
                >
