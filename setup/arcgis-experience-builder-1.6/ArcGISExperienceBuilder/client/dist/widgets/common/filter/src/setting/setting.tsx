                    ...
                    config.filterItems.length > 1 && <SettingRow>
                      <ButtonGroup className='w-100 and-or-group'>
                        <Button
                          ...
                          aria-pressed={config.logicalOperator === ClauseLogic.And}
                        >
                        ...
                        <Button
                          ...
                          aria-pressed={config.logicalOperator === ClauseLogic.Or}
                        >
                          <div className='text-truncate'>
                            {this.i18nMessage('or')}
                          </div>
                  ...
                  <Label className='w-100 d-flex'>
                    ...
                    <div className='m-0 ml-2 flex-grow-1 omit-label'>
                      ...
                      <Tooltip title={this.i18nMessage('omitInternalStyleTip')} showArrow placement='left'>
                        <Button icon type='tertiary' size='sm' className='ml-2 p-0' aria-label={this.i18nMessage('omitInternalStyleTip')}>
                          <InfoOutlined />
                        </Button>
                      </Tooltip>
                    </div>
