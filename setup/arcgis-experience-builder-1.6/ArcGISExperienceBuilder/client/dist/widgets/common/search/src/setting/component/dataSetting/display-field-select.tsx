/** @jsx jsx */
import { React, jsx, css, FieldSchema, IMState, ReactRedux, Immutable, JimuFieldType, IMFieldSchema, UseDataSource } from 'jimu-core'
...
const DisplayFieldSelect = (props: DisplayFieldProps) => {
  ...
  const theme = ReactRedux.useSelector(
