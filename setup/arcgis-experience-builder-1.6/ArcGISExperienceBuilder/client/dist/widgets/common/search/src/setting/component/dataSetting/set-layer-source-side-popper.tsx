...
import { hooks, TextInput, Checkbox, PanelHeader, defaultMessages as jimuiDefaultMessage } from 'jimu-ui'
...
const LayerSourceSidePopper = (props: LayerSourceSidePopperProps) => {
  ...
  const { trigger, isOpen, id, config, dsConfigItemIndex, toggle, updateConfigForLayerOptions, onSettingChange } = props
  ...
  */
  ...
  return (
    <SidePopper isOpen={isOpen} position='right' toggle={toggle} trigger={trigger}>
      {/* Header */}
      <PanelHeader className='pt-3 px-3' title={nls('setLayerSource')} onClose={toggle} />
