...
import { Button, Select, ImageParam, CropParam, ImageFillMode, Slider, NumericInput, Tabs, Tab } from 'jimu-ui'
        ...
        <div className='widget-setting-image'>
          ...
          <SettingSection>
            <SettingRow>
              ...
              >
                <LinkTiltedOutlined className='mr-3' />{this.props.intl.formatMessage({ id: 'setLinkForImage', defaultMessage: defaultMessages.setLinkForImage })}
              </Button>
            </SettingRow>
            <ToolTipSetting
