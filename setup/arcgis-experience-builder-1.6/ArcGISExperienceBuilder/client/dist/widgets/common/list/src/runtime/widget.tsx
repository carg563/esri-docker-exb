...
export class Widget extends React.PureComponent<ListProps, ListStates> {
  ...
  getListMaxSize = () => {
    ...
    const maxheight = isListHeightCustom ? boundingBox?.height : this.bodySize.scrollHeight
    const isListHeightCustomUnitPX = isListHeightCustom && !boundingBox?.height?.includes('%')
