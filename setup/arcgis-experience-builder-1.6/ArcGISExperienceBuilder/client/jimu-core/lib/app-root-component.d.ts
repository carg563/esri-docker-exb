...
declare const _default: React.FC<import("react-intl").WithIntlProps<import("react-redux").Omit<React.ClassAttributes<AppRootComponent> & StateProps & IntlProps, "queryObject" | "hasNewVersion" | "appPath" | "userLocaleChanged" | "hasPrivilege" | "privilegeError" | "loadAppConfigError" | "isRTL" | "dispatch" | "pages" | "customTheme" | "currentDialogId" | "isBusy" | "loadingType" | "themeVariables" | "dialogJson" | "appConfigLoaded" | "themeName"> & IntlProps>> & {
