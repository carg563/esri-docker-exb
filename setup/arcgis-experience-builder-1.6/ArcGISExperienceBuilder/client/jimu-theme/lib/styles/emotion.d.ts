 ...
 * If the theme is updated, the child component will be re-rendered accordingly.
 */
export declare const withTheme: <C extends React.ComponentType<React.ComponentProps<C>>>(component: C) => React.FC<DistributiveOmit<JSX.LibraryManagedAttributes<C, React.ComponentProps<C>>, "theme"> & {
